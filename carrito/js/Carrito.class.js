class Carrito{
    ...
    AgregarCursoCarrito(InformacionCurso, TablaCarrito, origen){
        ...
        if(ManipularLocalStorage.VerificarCursoRepetido(InformacionCurso.id) && origen) return; 
        ...
        if(origen) ManipularLocalStorage.AgregarCarritoLocalStorage(InformacionCurso); 
